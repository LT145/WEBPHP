<footer class="bg-black text-white mt-10 pt-10 pb-6">
    <div class="container mx-auto px-5 flex flex-col md:flex-row md:space-x-10 space-y-10 md:space-y-0">
        ...
        <div class="flex-1">
            ...
            <form class="space-y-4">
                ...
                <button type="button" onclick="SendMail()" class="bg-gray-500 hover:bg-gray-600 text-white text-sm px-5 py-3 rounded-full w-full">
                    Gửi
                </button>
            </form>
        </div>
