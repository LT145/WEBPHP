...
try {
    ...
    $sql = "SELECT * FROM user WHERE role = 'admin'"; // Thay 'user' thành 'admin'
...
<body class="bg-gray-100">
    <div class="container mx-auto p-4" style="min-width: 1024px;">
        ...
        <h1 class="text-2xl font-bold mb-4">Danh sách admin</h1>
